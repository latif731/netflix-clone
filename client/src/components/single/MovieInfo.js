...
const MovieInfo = ({ movie, setModalOpen, progress, DownloadVideo }) => {
            ...
            <div className="col-span-3 flex flex-col gap-10">
              ...
              <div className="grid sm:grid-cols-5 grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg ">
                ...
                <div className="col-span-2 flex-colo font-medium text-sm">
                  <p>
                    Langauge :{""}<span className="ml-3 truncate">{movie.language}</span>
                  </p>
                </div>
                {/* watch button */}
              ...
              {/* ratings */}
              <div className="flex mb-6 text-lg items-center gap-2 text-star">
                <Rating value={movie?.rate}/>
                <p style={{ marginLeft:"20px"}}>{movie.rate}</p>
              </div>
            </div>
